...
export class HttpService {
  ...
  updateDepartment(department: Department, oldDeptId: number): Observable<HttpResponse<any>> {
  ...
  assignEmployeeToDepartment(employeeId: number, departmentId: number): Observable<HttpResponse<any>> {
    return this.http.put(this.url + `department/${departmentId}/employee/${employeeId}`, null, { observe: 'response' });
  }

  removeEmployee(employeeId: number): Observable<HttpResponse<any>> {
