...
import com.skillstorm.spring_initialzr_web_version.services.DepartmentService;
...
//	}
	...
	@PutMapping
	public int updateDepartment(@RequestParam int id, @RequestParam String name, @RequestParam int oldId, @RequestBody List<Employee> employees) {
		return service.updateDepartment(id, name, oldId, employees);
	}
