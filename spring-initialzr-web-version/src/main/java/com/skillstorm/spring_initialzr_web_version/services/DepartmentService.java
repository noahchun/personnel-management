...
import com.skillstorm.spring_initialzr_web_version.repositories.DepartmentRepository;
...
//	}
	...
	// update one
	public int updateDepartment(int id, String name, int oldId, List<Employee> employees) {
		if (!repo.existsById(oldId))
			return 0;
		return repo.update(id, name, oldId);
	}
